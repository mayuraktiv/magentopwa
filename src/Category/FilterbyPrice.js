...
import '../style/partials/_inputrange.scss'


export default class FilterPriceRange extends React.Component {
    state = {
        sliderWidth: 0,
        offsetSliderWidht: 0,
        min: 0,
    ...
    componentDidMount() {
        ...
        this.setState({
            sliderWidth: this.priceslider.offsetWidth,
            offsetSliderWidht: this.priceslider.offsetLeft,
        })
    }
    ...
    render() {
        ...
        return (
            <div className="filter-options-item">
                <Collapsible open trigger="Filter by Price">
                    <div className="filter-options-content">
                        ...
                        <div ref={ref => this.priceslider = ref} id="priceslider">
