          ...
          <div className="block-dashboard-info">
            <div className="box-information">
              ...
              <div className="box-content">
                <p>
                  username<br></br>test06562@gmail.com
                </p>
              </div>
              <div className="box-action">
                ...
                <a href="#" className="edit btn btn-default btn-bg btn-xs">
                  Edit
                </a>
              </div>
            </div>
          ...
          <div className="block-dashboard-addresses">
            ...
            <div className="block-content">
              <div className="box-billing-address">
                ...
                <address>
                  test test<br></br>test<br></br>28 S High St<br></br>West
                  Chester, Pennsylvania, 19382<br></br>United States<br></br>T:
                  1234567891
                </address>
                <div className="box-action">
                  ...
                  <a href="#" className="btn btn-default btn-bg">
                    Manage Addresses
                  </a>
                </div>
              </div>
