...
import addressApp from "../controllers/apps/addressApp";

class AddAddress extends addressApp {
    render() {
        return (
                                    ...
                                    <Fragment>
                                        ...
                                        >
                                            ...
                                            {this.state.states?.map((item) => (
                                                <option value={item.id} key={`region-${item.id}`}>
                                                    {item.name}
                                                </option>
                                            ))}
                                        </select>
                    ...
                    <div className="primary">
                        {this.state.loading
                            ...
                            <button type="submit" className={this.state.isValidForm ? "btn btn-default" : "btn btn-default disabled"} disabled={!this.state.isValidForm}>
                                <span>{this.props.type === "edit" ? "Update" : "Save"}</span>
                            </button>
                        }
                    </div>
                </div>
...
export default connect(addressApp.mapStateToProps, addressApp.mapDispatchToProps)(AddAddress);